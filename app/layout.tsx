...
export const metadata: Metadata = {
  ...
  description:
    "An interactive genealogy spanning 720 years, 6 countries, and 35+ surnames — from medieval England to the American West.",
};
      ...
      <body className="flex min-h-full flex-col">
        ...
        >
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--text-low-emphasis)" }}>
            720 years of family history across 6 countries
          </p>
        </footer>
      </body>
    </html>
